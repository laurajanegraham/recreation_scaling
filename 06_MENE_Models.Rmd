...
We're making one big dataframe of the response (MENE visits) and covariates at each of the analysis resolutions. 
...
mene_aic %>% kable
write_csv(mene_aic, "doc/table2_mene_aic.csv")
```
